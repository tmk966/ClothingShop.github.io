...
class AdminController extends Controller
{
    ...
    public function pxlsp($id)
    {
        ...
        return redirect('admin/loai-san-pham')->with('tb', "Xoa thanh cong");
    }
    ...
    public function ptncc(Request $request)
    {
        ...
        if (count($ncc) > 0) {
            ...
            return redirect('admin/nha-cung-cap')->with('tb', 'Them thanh cong');
        }
    ...
    public function pxncc($id)
    {
        ...
        return redirect('admin/nha-cung-cap')->with('tb', 'Xoa thanh cong');
    }
