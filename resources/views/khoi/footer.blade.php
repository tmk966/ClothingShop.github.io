    ...
    <div class=" container">
        ...
        <div class="footer-top1">
            <div class="col-md-4 animated wow fadeInRight" data-wow-delay=".5s">
                ...
                <h3><b>Hỗ trợ</b></h3>
                Nếu bạn gặp rắc rối về sản phẩm hay chất lượng dịch vụ của <b>Phong Ken</b>, hãy gọi ngay đến số 0907284612
                hoặc
                inbox ở fanpage <a href="https://www.facebook.com/dx.phongken">fb.com/phongken</a>
                <div class="clearfix"></div>
            </div>
            <div class="col-md-4 animated wow fadeInRight" data-wow-delay=".5s">
                <br>
                Đặt hàng và thu tiền tận nơi trên toàn quốc <br>
                Liên hệ: 0907284612 <br> <br>
                <h3></h3>
                <div class="clearfix"></div>
            </div>
            {{--<div class="col-md-4 animated wow fadeInRight" data-wow-delay=".5s">--}}
